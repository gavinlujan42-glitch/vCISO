# AEGIS Enterprise Delivery Roadmap

## Release 0.1 — Enterprise Foundation
- [x] Executive prototype shell
- [x] Six-state explainable business-unit risk scoring
- [x] Multi-tenant RBAC domain contracts
- [x] Security remediation SLA and ownership logic
- [x] Normalized engineering evidence model
- [x] Contract/SOW/milestone/invoice assurance model
- [x] Executive Attention Queue scoring
...
- [ ] Executive and board report generation

## Release 1.0 — Enterprise Readiness
- [ ] HA/deployment architecture
- [ ] Backup and disaster recovery procedures
- [ ] Threat model and penetration testing
- [ ] SAST/SCA/secret scanning gates
- [ ] Accessibility and performance gates
- [ ] Operational SLOs and runbooks
- [ ] Security/privacy administration surfaces
- [ ] Production change-management controls
